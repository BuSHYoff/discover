      ...
      body: Column(children: [
        Container(
          ...
          child: Row(children: [
            ...
            Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
              Text('Pour aller plus loin', style: GoogleFonts.firaSansCondensed(fontSize: 20, fontWeight: FontWeight.w700, color: AppColors.ink)),
        ...
        Expanded(
          child: _loading
            ...
            children: [
              Text('Les meilleures ressources pour progresser rapidement en ${widget.passion.name}.',
                  style: GoogleFonts.firaSansCondensed(fontSize: 14, color: AppColors.inkSoft, height: 1.5)),
                  ...
                  child: InkWell(
                    ...
                    child: Container(
                      ...
                      child: Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
                        ...
                        Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                          Text(r.title, style: GoogleFonts.firaSansCondensed(fontSize: 13.5, fontWeight: FontWeight.w600, color: AppColors.ink)),
                          const SizedBox(height: 3),
                          Text(r.detail, style: GoogleFonts.firaSansCondensed(fontSize: 12, height: 1.4, color: AppColors.inkSoft)),
                          if (canOpen) ...[
                            const SizedBox(height: 6),
                            Row(children: [
                              Icon(Icons.open_in_new_rounded, size: 12, color: primary.withValues(alpha: 0.8)),
                              const SizedBox(width: 4),
                              Text('Ouvrir la ressource', style: GoogleFonts.firaSansCondensed(fontSize: 11, color: primary.withValues(alpha: 0.85))),
                            ]),
                          ],
                        ])),
                        ...
                        Container(
                          ...
                          child: Text(_typeLabels[r.type] ?? r.type, style: GoogleFonts.firaSansCondensed(fontSize: 10, fontWeight: FontWeight.w600, color: AppColors.ink.withValues(alpha: 0.5))),
                        ),
                      ]),
                    ),
                  ),
